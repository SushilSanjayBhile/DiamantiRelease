...
def TCAGGREGATE(Release):
        ...
        dictionary['AvailableSubDomainOptions'] = []
        ...
        tcinfo = TC_INFO.objects.using(Release).values('SubDomain').distinct()
        for tc in tcinfo:
            dictionary['AvailableSubDomainOptions'].append(tc['SubDomain'])
    ...
    if request.method == "GET":
        ...
        if(Release == 'all'):
            ...
            for i in serializer.data:
                ...
                if(i['ReleaseNumber'] == "master") or (i['ReleaseNumber'] == "2.3.0"):
