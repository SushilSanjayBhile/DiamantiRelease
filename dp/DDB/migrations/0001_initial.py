# Generated by Django 2.2.7 on 2020-01-07 13:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('BuildNumberList', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=11), blank=True, size=None)),
                ('EngineerCount', models.IntegerField(blank=True, default=0)),
                ('CardType', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=10), blank=True, size=None)),
                ('ServerType', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=10), blank=True, size=None)),
                ('SetupsUsed', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=10), blank=True, size=None)),
                ('QAStartDate', models.DateTimeField(blank=True)),
                ('TargetedReleaseDate', models.DateTimeField(blank=True)),
                ('ActualReleaseDate', models.DateTimeField(blank=True)),
                ('TargetedCodeFreezeDate', models.DateTimeField(blank=True)),
                ('UpgradeTestingStartDate', models.DateTimeField(blank=True)),
                ('UpgradeMetrics', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=10), blank=True, null=True, size=None)),
                ...
                ('QARateOfProgress', models.IntegerField(default=-1)),
            ],
        ),
        migrations.CreateModel(
            name='TC_INFO',
            fields=[
                ...
                ('Scenario', models.CharField(default='UNKNOWN', max_length=200)),
                ('Description', models.TextField(blank=True)),
                ('ExpectedBehaviour', models.CharField(blank=True, max_length=5000)),
                ('Notes', models.CharField(blank=True, max_length=2000)),
                ('CardType', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, default=None, max_length=100), blank=True, size=None)),
                ...
                ('OrchestrationPlatform', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=10), blank=True, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Designation', models.CharField(default='UNKNOWN', max_length=20)),
